...
<div class="app-shell" data-app-shell>
    <aside class="sidebar" data-sidebar>
        ...
        <div class="sidebar-footer">
            ...
            <span class="nav-label"><?= $integration ? 'Integração ' . h((string)($integration['status'] ?? 'ativa')) : 'Sem integração' ?></span>
        </div>
    </aside>
    <main class="app-main">
<div class="container">
    <header class="page-header">
        ...
        <div class="header-actions">
            <a class="small-btn ghost-link" href="upload_hotmart.php">Importar Hotmart</a>
            <a class="small-btn ghost-link" href="../logout.php">Sair</a>
        </div>
    </header>
